...
//void MyStrCopy(char*& title, const char*& sourceTitle, int maxLength) {
//	int i = 0;
//	for (; i < maxLength - 1 && sourceTitle[i] != '\0'; i++)
//	{
//		title[i] = sourceTitle[i];
//	}
//	//title[maxLength - 1] = '\0';
//	title[i] = '\0';
//}
...
//
//
//void ShowAllBooks(Book**& books, int& quantity) {
//	for (int i = 0; i < quantity; i++)
//	{
//		cout << "Book ID: " << books[i]->bookID
//			 << "\n The title: " << books[i]->title
//			 << "\n The author: " << books[i]->author
//			 << "\n The number of pages: " << books[i]->pageCount
//			 << "\n The price: " << books[i]->price << "\n\n";
//	}
//}
//
...
//
//
//void AddBook(Book**& books, int& quantity,const char* title, const char* author, int pageCount, int bookID, float price) {
//	/*char title[30], author[30];
//	int pageCount, bookID;
//	float price;*/
//
//	Book* newBook = new Book;
//	//MyStrCopy(newBook->title, title, 30);
...
//
//	Book** newBooksArray = new Book * [quantity + 1];
//	for (int i = 0; i < quantity; i++)
//	{
//		newBooksArray[i] = books[i];
//	}
//	newBooksArray[quantity] = newBook;
//	delete[] books;
//	books = newBooksArray;
//	quantity++;
//}
//
//bool BookExists(Book**& books, int& quantity, int& bookID) {
//	for (int i = 0; i < quantity; i++)
//	{
//		if (books[i]->bookID == bookID) {
//			return true;
